                ...
                <div class="card card-shadow mb-4 ">
                    <div class="card-header border-0">
                        <div class="custom-title-wrap bar-warning">
                            <div class="custom-title">Edit User</div>
                        </div>
                    </div>
                    <div class="card-body p-0 row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="gov_id" name="gov_id" placeholder="GOV ID" value="{{ $user->id }}"
                                           required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group date dpYears" data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="{{ $user->dob }}">
                                        <input type="text" class="form-control" aria-label="Right Icon" aria-describedby="dp-ig" name="dob" value="{{ $user->dob }}">
