        ...
        <div class="row">
            <div class="col-xl-12 d-lg-flex align-items-center">
                ...
                <div class="login-form">
                    <h4 class="text-uppercase text-success text-center mb-5">Register</h4>
                    <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                        <input id="govID" type="text" placeholder="GOV-ID" class="form-control{{ $errors->has('govID') ? ' is-invalid' : '' }}" name="govID" value="{{ old('govID') }}" required autofocus>
                                        @if ($errors->has('govID'))
                                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group mb-4">
                            <input id="password_confirmation" type="password" placeholder="password_confirmation" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" name="password_confirmation" required>
                            @if ($errors->has('password'))
                                <span class="invalid-feedback" role="alert">
